...
## Tech Stack
Techbologies used in this project include Python (Pandas, SQLAlchemy), Apache Airflow, PostgreSQL, Docker, and SQL. The project is fully containerized and designed to reflect a production-style ETL workflow.
